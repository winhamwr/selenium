/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/rel-2.0-xr-osx64-bld/build/toolkit/components/places/public/nsITaggingService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsITaggingService : public nsISupports {
 public: 
   ...
   */
  /* void getTagsForURI (in nsIURI aURI, [optional] out unsigned long length, [array, retval, size_is (length)] out wstring aTags); */
