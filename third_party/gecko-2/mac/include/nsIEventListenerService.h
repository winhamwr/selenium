/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/rel-2.0-xr-osx64-bld/build/content/events/public/nsIEventListenerService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIEventListenerService : public nsISupports {
 public: 
   ...
   */
  /* void getListenerInfoFor (in nsIDOMEventTarget aEventTarget, [optional] out unsigned long aCount, [array, retval, size_is (aCount)] out nsIEventListenerInfo aOutArray); */
  ...
  */
  /* void getEventTargetChainFor (in nsIDOMEventTarget aEventTarget, [optional] out unsigned long aCount, [array, retval, size_is (aCount)] out nsIDOMEventTarget aOutArray); */
