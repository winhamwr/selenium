/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/rel-2.0-xr-osx64-bld/build/modules/plugin/base/public/nsIPluginHost.idl
 */
...
class NS_SCRIPTABLE nsIPluginHost : public nsISupports {
 public: 
  ...
  /* void getPluginTags ([optional] out unsigned long aPluginCount, [array, retval, size_is (aPluginCount)] out nsIPluginTag aResults); */
