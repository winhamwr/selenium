/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/rel-2.0-xr-osx64-bld/build/toolkit/components/passwordmgr/public/nsILoginManagerIEMigrationHelper.idl
 */
