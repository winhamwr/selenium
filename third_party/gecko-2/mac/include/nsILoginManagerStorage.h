/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/rel-2.0-xr-osx64-bld/build/toolkit/components/passwordmgr/public/nsILoginManagerStorage.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsILoginManagerStorage : public nsISupports {
 public: 
  ...
  /**
     ...
     *       (|logins| is an array).
     */
  /* void getAllLogins ([optional] out unsigned long count, [array, retval, size_is (count)] out nsILoginInfo logins); */
  ...
  /**
    ...
    *       (|logins| is an array).
    */
  /* void getAllEncryptedLogins ([optional] out unsigned long count, [array, retval, size_is (count)] out nsILoginInfo logins); */
  ...
  /**
     ...
     */
  /* void getAllDisabledHosts ([optional] out unsigned long count, [array, retval, size_is (count)] out wstring hostnames); */
