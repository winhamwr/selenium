/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/rel-2.0-xr-osx64-bld/build/widget/public/nsIGfxInfo.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIGfxInfo : public nsISupports {
 public: 
  ...
  /* void getFailures ([optional] out unsigned long failureCount, [array, retval, size_is (failureCount)] out string failures); */
