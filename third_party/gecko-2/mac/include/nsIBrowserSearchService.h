/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/rel-2.0-xr-osx64-bld/build/netwerk/base/public/nsIBrowserSearchService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIBrowserSearchService : public nsISupports {
 public: 
   ...
   */
  /* void getEngines ([optional] out unsigned long engineCount, [array, retval, size_is (engineCount)] out nsISearchEngine engines); */
   ...
   * @returns an array of nsISearchEngine objects.
   */
  /* void getVisibleEngines ([optional] out unsigned long engineCount, [array, retval, size_is (engineCount)] out nsISearchEngine engines); */
   ...
   * @returns an array of nsISearchEngine objects.
   */
  /* void getDefaultEngines ([optional] out unsigned long engineCount, [array, retval, size_is (engineCount)] out nsISearchEngine engines); */
