/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/rel-2.0-xr-osx64-bld/build/toolkit/components/places/public/nsINavHistoryService.idl
 */
...
/**
   ...
   */
  /* void getQueries ([optional] out unsigned long queryCount, [array, retval, size_is (queryCount)] out nsINavHistoryQuery queries); */
...
/**
   ...
   */
  /* void getTransitions ([optional] out unsigned long count, [array, retval, size_is (count)] out unsigned long transitions); */
   ...
   */
  /* void getFolders ([optional] out unsigned long count, [array, retval, size_is (count)] out long long folders); */
