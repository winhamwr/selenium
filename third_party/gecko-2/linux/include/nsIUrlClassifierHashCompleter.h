/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/rel-2.0-xr-lnx-bld/build/toolkit/components/url-classifier/public/nsIUrlClassifierHashCompleter.idl
 */
