/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-2.0-xr-w32-bld/build/dom/interfaces/core/nsIDOMNSDocument.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMNSDocument_MOZILLA_2_0_BRANCH : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetMozCurrentStateObject(nsIVariant **aMozCurrentStateObject) = 0;
...
#define NS_DECL_NSIDOMNSDOCUMENT_MOZILLA_2_0_BRANCH \
  NS_IMETHOD GetMozCurrentStateObject(nsIVariant **aMozCurrentStateObject); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMNSDOCUMENT_MOZILLA_2_0_BRANCH(_to) \
  NS_IMETHOD GetMozCurrentStateObject(nsIVariant **aMozCurrentStateObject) { return _to GetMozCurrentStateObject(aMozCurrentStateObject); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMNSDOCUMENT_MOZILLA_2_0_BRANCH(_to) \
  NS_IMETHOD GetMozCurrentStateObject(nsIVariant **aMozCurrentStateObject) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozCurrentStateObject(aMozCurrentStateObject); } 
