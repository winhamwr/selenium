/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-2.0-xr-w32-bld/build/dom/interfaces/canvas/nsIDOMWebGLRenderingContext.idl
 */
...
/* starting interface:    nsIDOMWebGLRenderingContext_MOZILLA_2_0_BRANCH */
#define NS_IDOMWEBGLRENDERINGCONTEXT_MOZILLA_2_0_BRANCH_IID_STR "23182042-3d92-407d-9b9b-37c9886398f7"

#define NS_IDOMWEBGLRENDERINGCONTEXT_MOZILLA_2_0_BRANCH_IID \
  {0x23182042, 0x3d92, 0x407d, \
    { 0x9b, 0x9b, 0x37, 0xc9, 0x88, 0x63, 0x98, 0xf7 }}

class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMWebGLRenderingContext_MOZILLA_2_0_BRANCH : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IDOMWEBGLRENDERINGCONTEXT_MOZILLA_2_0_BRANCH_IID)
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(nsIDOMWebGLRenderingContext_MOZILLA_2_0_BRANCH, NS_IDOMWEBGLRENDERINGCONTEXT_MOZILLA_2_0_BRANCH_IID)

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIDOMWEBGLRENDERINGCONTEXT_MOZILLA_2_0_BRANCH \
...
/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMWEBGLRENDERINGCONTEXT_MOZILLA_2_0_BRANCH(_to) \
...
/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMWEBGLRENDERINGCONTEXT_MOZILLA_2_0_BRANCH(_to) \
...
/* Header file */
class nsDOMWebGLRenderingContext_MOZILLA_2_0_BRANCH : public nsIDOMWebGLRenderingContext_MOZILLA_2_0_BRANCH
{
public:
  NS_DECL_ISUPPORTS
  NS_DECL_NSIDOMWEBGLRENDERINGCONTEXT_MOZILLA_2_0_BRANCH

  nsDOMWebGLRenderingContext_MOZILLA_2_0_BRANCH();
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsDOMWebGLRenderingContext_MOZILLA_2_0_BRANCH, nsIDOMWebGLRenderingContext_MOZILLA_2_0_BRANCH)

nsDOMWebGLRenderingContext_MOZILLA_2_0_BRANCH::nsDOMWebGLRenderingContext_MOZILLA_2_0_BRANCH()
{
  /* member initializers and constructor code */
}
...
/* nsIVariant getSupportedExtensions (); */
NS_IMETHODIMP nsDOMWebGLRenderingContext_MOZILLA_2_0_BRANCH::GetSupportedExtensions(nsIVariant **_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* WebGLboolean isContextLost (); */
NS_IMETHODIMP nsDOMWebGLRenderingContext_MOZILLA_2_0_BRANCH::IsContextLost(WebGLboolean *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
