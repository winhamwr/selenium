/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-2.0-xr-w32-bld/build/toolkit/components/startup/public/nsIAppStartup.idl
 */
...
#define NS_IAPPSTARTUP2_IID_STR "e233d663-d014-43b0-8649-7145ecf0a0b1"

#define NS_IAPPSTARTUP2_IID \
  {0xe233d663, 0xd014, 0x43b0, \
    { 0x86, 0x49, 0x71, 0x45, 0xec, 0xf0, 0xa0, 0xb1 }}
...
/* starting interface:    nsIAppStartup_MOZILLA_2_0 */
#define NS_IAPPSTARTUP_MOZILLA_2_0_IID_STR "2e8c45b0-1ac1-11e0-ac64-0800200c9a66"

#define NS_IAPPSTARTUP_MOZILLA_2_0_IID \
  {0x2e8c45b0, 0x1ac1, 0x11e0, \
    { 0xac, 0x64, 0x08, 0x00, 0x20, 0x0c, 0x9a, 0x66 }}

class NS_NO_VTABLE NS_SCRIPTABLE nsIAppStartup_MOZILLA_2_0 : public nsIAppStartup2 {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IAPPSTARTUP_MOZILLA_2_0_IID)
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(nsIAppStartup_MOZILLA_2_0, NS_IAPPSTARTUP_MOZILLA_2_0_IID)

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIAPPSTARTUP_MOZILLA_2_0 \
  NS_SCRIPTABLE NS_IMETHOD GetStartupInfo(void); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIAPPSTARTUP_MOZILLA_2_0(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetStartupInfo(void) { return _to GetStartupInfo(); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIAPPSTARTUP_MOZILLA_2_0(_to) \
...
/* Header file */
class nsAppStartup_MOZILLA_2_0 : public nsIAppStartup_MOZILLA_2_0
{
public:
  NS_DECL_ISUPPORTS
  NS_DECL_NSIAPPSTARTUP_MOZILLA_2_0

  nsAppStartup_MOZILLA_2_0();
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsAppStartup_MOZILLA_2_0, nsIAppStartup_MOZILLA_2_0)

nsAppStartup_MOZILLA_2_0::nsAppStartup_MOZILLA_2_0()
{
  /* member initializers and constructor code */
}
...
/* void getStartupInfo (); */
NS_IMETHODIMP nsAppStartup_MOZILLA_2_0::GetStartupInfo()
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
