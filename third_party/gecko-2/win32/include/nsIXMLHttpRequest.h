/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-2.0-xr-w32-bld/build/content/base/public/nsIXMLHttpRequest.idl
 */
...
#define NS_IXMLHTTPREQUEST_IID_STR "6bb91106-85f0-4d93-8cb4-e57b3d0624f2"

#define NS_IXMLHTTPREQUEST_IID \
  {0x6bb91106, 0x85f0, 0x4d93, \
    { 0x8c, 0xb4, 0xe5, 0x7b, 0x3d, 0x06, 0x24, 0xf2 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIXMLHttpRequest : public nsISupports {
 public: 
   ...
   * has not yet been sent.
   */
  /* readonly attribute jsval mozResponseArrayBuffer; */
  NS_SCRIPTABLE NS_IMETHOD GetMozResponseArrayBuffer(jsval *aMozResponseArrayBuffer) = 0;
   ...
   *                 The default value is the empty string
   */
  /* [optional_argc] void open (in AUTF8String method, in AUTF8String url, [optional] in boolean async, [Undefined (Empty), optional] in DOMString user, [Undefined (Empty), optional] in DOMString password); */
...
#define NS_DECL_NSIXMLHTTPREQUEST \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozResponseArrayBuffer(jsval *aMozResponseArrayBuffer); \
...
#define NS_FORWARD_NSIXMLHTTPREQUEST(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozResponseArrayBuffer(jsval *aMozResponseArrayBuffer) { return _to GetMozResponseArrayBuffer(aMozResponseArrayBuffer); } \
...
#define NS_FORWARD_SAFE_NSIXMLHTTPREQUEST(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozResponseArrayBuffer(jsval *aMozResponseArrayBuffer) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozResponseArrayBuffer(aMozResponseArrayBuffer); } \
...
/* readonly attribute jsval mozResponseArrayBuffer; */
NS_IMETHODIMP nsXMLHttpRequest::GetMozResponseArrayBuffer(jsval *aMozResponseArrayBuffer)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
 ...
 * @deprecated
 */
class NS_NO_VTABLE NS_SCRIPTABLE NS_DEPRECATED nsIJSXMLHttpRequest : public nsISupports {
 public: 
