/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-2.0-xr-w32-bld/build/dom/interfaces/base/nsIDOMHistory.idl
 */
...
/* starting interface:    nsIDOMHistory_MOZILLA_2_0_BRANCH */
#define NS_IDOMHISTORY_MOZILLA_2_0_BRANCH_IID_STR "949fcdc1-664b-4a4b-939a-7144c94b48ac"

#define NS_IDOMHISTORY_MOZILLA_2_0_BRANCH_IID \
  {0x949fcdc1, 0x664b, 0x4a4b, \
    { 0x93, 0x9a, 0x71, 0x44, 0xc9, 0x4b, 0x48, 0xac }}

class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMHistory_MOZILLA_2_0_BRANCH : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IDOMHISTORY_MOZILLA_2_0_BRANCH_IID)
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(nsIDOMHistory_MOZILLA_2_0_BRANCH, NS_IDOMHISTORY_MOZILLA_2_0_BRANCH_IID)

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIDOMHISTORY_MOZILLA_2_0_BRANCH \
  NS_SCRIPTABLE NS_IMETHOD GetState(nsIVariant **aState); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMHISTORY_MOZILLA_2_0_BRANCH(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetState(nsIVariant **aState) { return _to GetState(aState); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMHISTORY_MOZILLA_2_0_BRANCH(_to) \
...
/* Header file */
class nsDOMHistory_MOZILLA_2_0_BRANCH : public nsIDOMHistory_MOZILLA_2_0_BRANCH
{
public:
  NS_DECL_ISUPPORTS
  NS_DECL_NSIDOMHISTORY_MOZILLA_2_0_BRANCH

  nsDOMHistory_MOZILLA_2_0_BRANCH();
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsDOMHistory_MOZILLA_2_0_BRANCH, nsIDOMHistory_MOZILLA_2_0_BRANCH)

nsDOMHistory_MOZILLA_2_0_BRANCH::nsDOMHistory_MOZILLA_2_0_BRANCH()
{
  /* member initializers and constructor code */
}
...
/* readonly attribute nsIVariant state; */
NS_IMETHODIMP nsDOMHistory_MOZILLA_2_0_BRANCH::GetState(nsIVariant **aState)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
