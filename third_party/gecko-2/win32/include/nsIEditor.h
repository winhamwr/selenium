/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-2.0-xr-w32-bld/build/editor/idl/nsIEditor.idl
 */
...
#define NS_IEDITOR_IID_STR "972e54e1-dec3-4e3f-87ec-408a7dbcfd92"

#define NS_IEDITOR_IID \
  {0x972e54e1, 0xdec3, 0x4e3f, \
    { 0x87, 0xec, 0x40, 0x8a, 0x7d, 0xbc, 0xfd, 0x92 }}
...
/* starting interface:    nsIEditor_MOZILLA_2_0_BRANCH */
#define NS_IEDITOR_MOZILLA_2_0_BRANCH_IID_STR "54c0bc08-6c0e-4967-bb0d-ec991d78a8b3"

#define NS_IEDITOR_MOZILLA_2_0_BRANCH_IID \
  {0x54c0bc08, 0x6c0e, 0x4967, \
    { 0xbb, 0x0d, 0xec, 0x99, 0x1d, 0x78, 0xa8, 0xb3 }}

class NS_NO_VTABLE nsIEditor_MOZILLA_2_0_BRANCH : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IEDITOR_MOZILLA_2_0_BRANCH_IID)
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(nsIEditor_MOZILLA_2_0_BRANCH, NS_IEDITOR_MOZILLA_2_0_BRANCH_IID)

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIEDITOR_MOZILLA_2_0_BRANCH \
  NS_IMETHOD GetLastKeypressEventTrusted(PRBool *aLastKeypressEventTrusted); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIEDITOR_MOZILLA_2_0_BRANCH(_to) \
...
/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIEDITOR_MOZILLA_2_0_BRANCH(_to) \
...
/* Header file */
class nsEditor_MOZILLA_2_0_BRANCH : public nsIEditor_MOZILLA_2_0_BRANCH
{
public:
  NS_DECL_ISUPPORTS
  NS_DECL_NSIEDITOR_MOZILLA_2_0_BRANCH

  nsEditor_MOZILLA_2_0_BRANCH();
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsEditor_MOZILLA_2_0_BRANCH, nsIEditor_MOZILLA_2_0_BRANCH)

nsEditor_MOZILLA_2_0_BRANCH::nsEditor_MOZILLA_2_0_BRANCH()
{
  /* member initializers and constructor code */
}
...
/* readonly attribute boolean lastKeypressEventTrusted; */
NS_IMETHODIMP nsEditor_MOZILLA_2_0_BRANCH::GetLastKeypressEventTrusted(PRBool *aLastKeypressEventTrusted)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
