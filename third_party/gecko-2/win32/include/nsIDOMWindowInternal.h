/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-2.0-xr-w32-bld/build/dom/interfaces/base/nsIDOMWindowInternal.idl
 */
...
#define NS_IDOMWINDOWINTERNAL_IID_STR "9d6a1157-0719-46a7-b49f-7ffeaa0b5c86"

#define NS_IDOMWINDOWINTERNAL_IID \
  {0x9d6a1157, 0x0719, 0x46a7, \
    { 0xb4, 0x9f, 0x7f, 0xfe, 0xaa, 0x0b, 0x5c, 0x86 }}
...
/* DOMString prompt ([optional] in DOMString aMessage, [optional] in DOMString aInitial); */
NS_IMETHODIMP nsDOMWindowInternal::Prompt(const nsAString & aMessage, const nsAString & aInitial, nsAString & _retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* readonly attribute unsigned long long mozPaintCount; */
NS_IMETHODIMP nsDOMWindowInternal::GetMozPaintCount(PRUint64 *aMozPaintCount)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void mozRequestAnimationFrame ([optional] in nsIAnimationFrameListener aListener); */
NS_IMETHODIMP nsDOMWindowInternal::MozRequestAnimationFrame(nsIAnimationFrameListener *aListener)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* readonly attribute long long mozAnimationStartTime; */
NS_IMETHODIMP nsDOMWindowInternal::GetMozAnimationStartTime(PRInt64 *aMozAnimationStartTime)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* starting interface:    nsIDOMWindow_2_0_BRANCH */
#define NS_IDOMWINDOW_2_0_BRANCH_IID_STR "05563c0c-b74c-41ad-91d1-bc22d580a581"

#define NS_IDOMWINDOW_2_0_BRANCH_IID \
  {0x05563c0c, 0xb74c, 0x41ad, \
    { 0x91, 0xd1, 0xbc, 0x22, 0xd5, 0x80, 0xa5, 0x81 }}

class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMWindow_2_0_BRANCH : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IDOMWINDOW_2_0_BRANCH_IID)
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(nsIDOMWindow_2_0_BRANCH, NS_IDOMWINDOW_2_0_BRANCH_IID)

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIDOMWINDOW_2_0_BRANCH \
  NS_SCRIPTABLE NS_IMETHOD GetURL(nsIDOMMozURLProperty **aURL); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMWINDOW_2_0_BRANCH(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetURL(nsIDOMMozURLProperty **aURL) { return _to GetURL(aURL); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMWINDOW_2_0_BRANCH(_to) \
...
/* Header file */
class nsDOMWindow_2_0_BRANCH : public nsIDOMWindow_2_0_BRANCH
{
public:
  NS_DECL_ISUPPORTS
  NS_DECL_NSIDOMWINDOW_2_0_BRANCH

  nsDOMWindow_2_0_BRANCH();
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsDOMWindow_2_0_BRANCH, nsIDOMWindow_2_0_BRANCH)

nsDOMWindow_2_0_BRANCH::nsDOMWindow_2_0_BRANCH()
{
  /* member initializers and constructor code */
}
...
/* readonly attribute nsIDOMMozURLProperty URL; */
NS_IMETHODIMP nsDOMWindow_2_0_BRANCH::GetURL(nsIDOMMozURLProperty **aURL)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
