/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-2.0-xr-w32-bld/build/xpcom/io/nsIFastLoadService.idl
 */
...
#define NS_IFASTLOADFILEIO_IID_STR "61cd17e0-b07a-4158-9817-36a206b100e9"

#define NS_IFASTLOADFILEIO_IID \
  {0x61cd17e0, 0xb07a, 0x4158, \
    { 0x98, 0x17, 0x36, 0xa2, 0x06, 0xb1, 0x00, 0xe9 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIFastLoadFileIO : public nsISupports {
 public: 
  ...
  NS_IMETHOD DisableTruncate(void) = 0;
...
#define NS_DECL_NSIFASTLOADFILEIO \
  ...
  NS_IMETHOD DisableTruncate(void); 
...
#define NS_FORWARD_NSIFASTLOADFILEIO(_to) \
  ...
  NS_IMETHOD DisableTruncate(void) { return _to DisableTruncate(); } 
...
#define NS_FORWARD_SAFE_NSIFASTLOADFILEIO(_to) \
  ...
  NS_IMETHOD DisableTruncate(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->DisableTruncate(); } 
...
/* [noscript] void disableTruncate (); */
NS_IMETHODIMP nsFastLoadFileIO::DisableTruncate()
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
#define NS_IFASTLOADSERVICE_IID_STR "c18df300-c2e4-4115-a61c-9110655f7dd8"

#define NS_IFASTLOADSERVICE_IID \
  {0xc18df300, 0xc2e4, 0x4115, \
    { 0xa6, 0x1c, 0x91, 0x10, 0x65, 0x5f, 0x7d, 0xd8 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIFastLoadService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD NewInputStream(nsIFile *aFile, nsIObjectInputStream **_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIFASTLOADSERVICE \
  ...
  NS_SCRIPTABLE NS_IMETHOD NewInputStream(nsIFile *aFile, nsIObjectInputStream **_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIFASTLOADSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD NewInputStream(nsIFile *aFile, nsIObjectInputStream **_retval NS_OUTPARAM) { return _to NewInputStream(aFile, _retval); } \
...
#define NS_FORWARD_SAFE_NSIFASTLOADSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD NewInputStream(nsIFile *aFile, nsIObjectInputStream **_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->NewInputStream(aFile, _retval); } \
...
/* nsIObjectInputStream newInputStream (in nsIFile aFile); */
NS_IMETHODIMP nsFastLoadService::NewInputStream(nsIFile *aFile, nsIObjectInputStream **_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
