/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-2.0-xr-w32-bld/build/xpcom/threads/nsIThreadInternal.idl
 */
...
/* starting interface:    nsIThreadInternal2 */
#define NS_ITHREADINTERNAL2_IID_STR "4531f101-fddc-4d36-80e7-35260a2f3afe"

#define NS_ITHREADINTERNAL2_IID \
  {0x4531f101, 0xfddc, 0x4d36, \
    { 0x80, 0xe7, 0x35, 0x26, 0x0a, 0x2f, 0x3a, 0xfe }}

/**
 * Temporary interface, will be merged into nsIThreadInternal.
 */
class NS_NO_VTABLE NS_SCRIPTABLE nsIThreadInternal2 : public nsIThreadInternal {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_ITHREADINTERNAL2_IID)
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(nsIThreadInternal2, NS_ITHREADINTERNAL2_IID)

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSITHREADINTERNAL2 \
...
/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSITHREADINTERNAL2(_to) \
...
/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSITHREADINTERNAL2(_to) \
...
/* Header file */
class nsThreadInternal2 : public nsIThreadInternal2
{
public:
  NS_DECL_ISUPPORTS
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsThreadInternal2, nsIThreadInternal2)

nsThreadInternal2::nsThreadInternal2()
{
  /* member initializers and constructor code */
}
...
/* readonly attribute unsigned long recursionDepth; */
NS_IMETHODIMP nsThreadInternal2::GetRecursionDepth(PRUint32 *aRecursionDepth)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void addObserver (in nsIThreadObserver observer); */
NS_IMETHODIMP nsThreadInternal2::AddObserver(nsIThreadObserver *observer)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void removeObserver (in nsIThreadObserver observer); */
NS_IMETHODIMP nsThreadInternal2::RemoveObserver(nsIThreadObserver *observer)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
