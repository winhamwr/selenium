/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-2.0-xr-w32-bld/build/modules/plugin/base/public/nsIPluginInstance.idl
 */
...
#define NS_IPLUGININSTANCE_MOZILLA_2_0_BRANCH_IID_STR "24235105-ac5f-483b-86ec-7c9446ddcb8a"

#define NS_IPLUGININSTANCE_MOZILLA_2_0_BRANCH_IID \
  {0x24235105, 0xac5f, 0x483b, \
    { 0x86, 0xec, 0x7c, 0x94, 0x46, 0xdd, 0xcb, 0x8a }}
...
class NS_NO_VTABLE nsIPluginInstance_MOZILLA_2_0_BRANCH : public nsIPluginInstance {
 public: 
  ...
  NS_IMETHOD GetImageSize(nsIntSize *aSize) = 0;
...
#define NS_DECL_NSIPLUGININSTANCE_MOZILLA_2_0_BRANCH \
  ...
  NS_IMETHOD GetImageSize(nsIntSize *aSize); \
...
#define NS_FORWARD_NSIPLUGININSTANCE_MOZILLA_2_0_BRANCH(_to) \
  ...
  NS_IMETHOD GetImageSize(nsIntSize *aSize) { return _to GetImageSize(aSize); } \
...
#define NS_FORWARD_SAFE_NSIPLUGININSTANCE_MOZILLA_2_0_BRANCH(_to) \
  ...
  NS_IMETHOD GetImageSize(nsIntSize *aSize) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetImageSize(aSize); } \
...
/* void getImageSize (in nsIntSizePtr aSize); */
NS_IMETHODIMP nsPluginInstance_MOZILLA_2_0_BRANCH::GetImageSize(nsIntSize *aSize)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
