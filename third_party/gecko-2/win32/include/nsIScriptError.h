/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-2.0-xr-w32-bld/build/js/src/xpconnect/idl/nsIScriptError.idl
 */
...
#define NS_ISCRIPTERROR2_IID_STR "35cd0f6a-f5bb-497a-ba83-9c8d089b52cd"

#define NS_ISCRIPTERROR2_IID \
  {0x35cd0f6a, 0xf5bb, 0x497a, \
    { 0xba, 0x83, 0x9c, 0x8d, 0x08, 0x9b, 0x52, 0xcd }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIScriptError2 : public nsISupports {
 public: 
  ...
  /* void initWithWindowID (in wstring message, in wstring sourceName, in wstring sourceLine, in PRUint32 lineNumber, in PRUint32 columnNumber, in PRUint32 flags, in string category, in unsigned long long windowID); */
  NS_SCRIPTABLE NS_IMETHOD InitWithWindowID(const PRUnichar *message, const PRUnichar *sourceName, const PRUnichar *sourceLine, PRUint32 lineNumber, PRUint32 columnNumber, PRUint32 flags, const char *category, PRUint64 windowID) = 0;
...
#define NS_DECL_NSISCRIPTERROR2 \
  ...
  NS_SCRIPTABLE NS_IMETHOD InitWithWindowID(const PRUnichar *message, const PRUnichar *sourceName, const PRUnichar *sourceLine, PRUint32 lineNumber, PRUint32 columnNumber, PRUint32 flags, const char *category, PRUint64 windowID); 
...
#define NS_FORWARD_NSISCRIPTERROR2(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD InitWithWindowID(const PRUnichar *message, const PRUnichar *sourceName, const PRUnichar *sourceLine, PRUint32 lineNumber, PRUint32 columnNumber, PRUint32 flags, const char *category, PRUint64 windowID) { return _to InitWithWindowID(message, sourceName, sourceLine, lineNumber, columnNumber, flags, category, windowID); } 
...
#define NS_FORWARD_SAFE_NSISCRIPTERROR2(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD InitWithWindowID(const PRUnichar *message, const PRUnichar *sourceName, const PRUnichar *sourceLine, PRUint32 lineNumber, PRUint32 columnNumber, PRUint32 flags, const char *category, PRUint64 windowID) { return !_to ? NS_ERROR_NULL_POINTER : _to->InitWithWindowID(message, sourceName, sourceLine, lineNumber, columnNumber, flags, category, windowID); } 
...
/* void initWithWindowID (in wstring message, in wstring sourceName, in wstring sourceLine, in PRUint32 lineNumber, in PRUint32 columnNumber, in PRUint32 flags, in string category, in unsigned long long windowID); */
NS_IMETHODIMP nsScriptError2::InitWithWindowID(const PRUnichar *message, const PRUnichar *sourceName, const PRUnichar *sourceLine, PRUint32 lineNumber, PRUint32 columnNumber, PRUint32 flags, const char *category, PRUint64 windowID)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
