/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-2.0-xr-w32-bld/build/layout/xul/base/public/nsIMenuBoxObject.idl
 */
...
/* starting interface:    nsIMenuBoxObject_MOZILLA_2_0_BRANCH */
#define NS_IMENUBOXOBJECT_MOZILLA_2_0_BRANCH_IID_STR "d03150f6-92a3-4307-a73c-864c8dad3f22"

#define NS_IMENUBOXOBJECT_MOZILLA_2_0_BRANCH_IID \
  {0xd03150f6, 0x92a3, 0x4307, \
    { 0xa7, 0x3c, 0x86, 0x4c, 0x8d, 0xad, 0x3f, 0x22 }}

class NS_NO_VTABLE NS_SCRIPTABLE nsIMenuBoxObject_MOZILLA_2_0_BRANCH : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IMENUBOXOBJECT_MOZILLA_2_0_BRANCH_IID)
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(nsIMenuBoxObject_MOZILLA_2_0_BRANCH, NS_IMENUBOXOBJECT_MOZILLA_2_0_BRANCH_IID)

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIMENUBOXOBJECT_MOZILLA_2_0_BRANCH \
  NS_SCRIPTABLE NS_IMETHOD GetOpenedWithKey(PRBool *aOpenedWithKey); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIMENUBOXOBJECT_MOZILLA_2_0_BRANCH(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetOpenedWithKey(PRBool *aOpenedWithKey) { return _to GetOpenedWithKey(aOpenedWithKey); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIMENUBOXOBJECT_MOZILLA_2_0_BRANCH(_to) \
...
/* Header file */
class nsMenuBoxObject_MOZILLA_2_0_BRANCH : public nsIMenuBoxObject_MOZILLA_2_0_BRANCH
{
public:
  NS_DECL_ISUPPORTS
  NS_DECL_NSIMENUBOXOBJECT_MOZILLA_2_0_BRANCH

  nsMenuBoxObject_MOZILLA_2_0_BRANCH();
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsMenuBoxObject_MOZILLA_2_0_BRANCH, nsIMenuBoxObject_MOZILLA_2_0_BRANCH)

nsMenuBoxObject_MOZILLA_2_0_BRANCH::nsMenuBoxObject_MOZILLA_2_0_BRANCH()
{
  /* member initializers and constructor code */
}
...
/* readonly attribute boolean openedWithKey; */
NS_IMETHODIMP nsMenuBoxObject_MOZILLA_2_0_BRANCH::GetOpenedWithKey(PRBool *aOpenedWithKey)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
