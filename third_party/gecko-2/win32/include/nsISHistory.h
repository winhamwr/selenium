/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-2.0-xr-w32-bld/build/docshell/shistory/public/nsISHistory.idl
 */
...
/* starting interface:    nsISHistory_2_0_BRANCH */
#define NS_ISHISTORY_2_0_BRANCH_IID_STR "ac8b3eb3-2051-4cce-8303-d6e7938501dd"

#define NS_ISHISTORY_2_0_BRANCH_IID \
  {0xac8b3eb3, 0x2051, 0x4cce, \
    { 0x83, 0x03, 0xd6, 0xe7, 0x93, 0x85, 0x01, 0xdd }}

class NS_NO_VTABLE NS_SCRIPTABLE nsISHistory_2_0_BRANCH : public nsISHistory {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_ISHISTORY_2_0_BRANCH_IID)
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(nsISHistory_2_0_BRANCH, NS_ISHISTORY_2_0_BRANCH_IID)

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSISHISTORY_2_0_BRANCH \
  NS_SCRIPTABLE NS_IMETHOD ReloadCurrentEntry(void); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISHISTORY_2_0_BRANCH(_to) \
  NS_SCRIPTABLE NS_IMETHOD ReloadCurrentEntry(void) { return _to ReloadCurrentEntry(); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISHISTORY_2_0_BRANCH(_to) \
...
/* Header file */
class nsSHistory_2_0_BRANCH : public nsISHistory_2_0_BRANCH
{
public:
  NS_DECL_ISUPPORTS
  NS_DECL_NSISHISTORY_2_0_BRANCH

  nsSHistory_2_0_BRANCH();
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsSHistory_2_0_BRANCH, nsISHistory_2_0_BRANCH)

nsSHistory_2_0_BRANCH::nsSHistory_2_0_BRANCH()
{
  /* member initializers and constructor code */
}
...
/* void reloadCurrentEntry (); */
NS_IMETHODIMP nsSHistory_2_0_BRANCH::ReloadCurrentEntry()
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
