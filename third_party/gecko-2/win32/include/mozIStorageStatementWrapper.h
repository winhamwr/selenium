/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-2.0-xr-w32-bld/build/storage/public/mozIStorageStatementWrapper.idl
 */
 ...
 */
class NS_NO_VTABLE NS_SCRIPTABLE NS_DEPRECATED mozIStorageStatementWrapper : public nsISupports {
 public: 
  ...
  NS_DEPRECATED NS_SCRIPTABLE NS_IMETHOD Step(PRBool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_MOZISTORAGESTATEMENTWRAPPER \
  ...
  NS_DEPRECATED NS_SCRIPTABLE NS_IMETHOD Step(PRBool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_MOZISTORAGESTATEMENTWRAPPER(_to) \
  ...
  NS_DEPRECATED NS_SCRIPTABLE NS_IMETHOD Step(PRBool *_retval NS_OUTPARAM) { return _to Step(_retval); } \
...
#define NS_FORWARD_SAFE_MOZISTORAGESTATEMENTWRAPPER(_to) \
  ...
  NS_DEPRECATED NS_SCRIPTABLE NS_IMETHOD Step(PRBool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Step(_retval); } \
