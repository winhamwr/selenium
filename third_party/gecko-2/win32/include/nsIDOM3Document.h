/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-2.0-xr-w32-bld/build/dom/interfaces/core/nsIDOM3Document.idl
 */
 ...
 */
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOM3Document : public nsISupports {
 public: 
