/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-2.0-xr-w32-bld/build/dom/interfaces/base/nsIDOMGlobalPropertyInitializer.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMGlobalPropertyInitializer : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Init(nsIDOMWindow *window, jsval *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIDOMGLOBALPROPERTYINITIALIZER \
  NS_SCRIPTABLE NS_IMETHOD Init(nsIDOMWindow *window, jsval *_retval NS_OUTPARAM); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMGLOBALPROPERTYINITIALIZER(_to) \
  NS_SCRIPTABLE NS_IMETHOD Init(nsIDOMWindow *window, jsval *_retval NS_OUTPARAM) { return _to Init(window, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMGLOBALPROPERTYINITIALIZER(_to) \
  NS_SCRIPTABLE NS_IMETHOD Init(nsIDOMWindow *window, jsval *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Init(window, _retval); } 
...
/* jsval init (in nsIDOMWindow window); */
NS_IMETHODIMP nsDOMGlobalPropertyInitializer::Init(nsIDOMWindow *window, jsval *_retval NS_OUTPARAM)
{
